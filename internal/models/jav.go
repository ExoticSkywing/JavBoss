...
const (
	JavInventoryAll      = "all"
	JavInventoryPending  = "pending"
	JavInventoryImported = "imported"
)
...
// Jav is the canonical work identity for one normalized code. Multiple active
...
type Jav struct {
	...
	MagnetCandidates       []JavMagnetCandidate     `json:"magnet_candidates,omitempty" gorm:"-"`
	MagnetSelection        *JavMagnetSelection      `json:"magnet_selection,omitempty" gorm:"-"`
	DownloadAttempt        *JavDownloadAttempt      `json:"download_attempt,omitempty" gorm:"-"`
	QualityReview          *JavQualityReviewSummary `json:"quality_review,omitempty" gorm:"-"`
	QualityAcceptance      *JavQualityAcceptance    `json:"quality_acceptance,omitempty" gorm:"-"`
}
