...
func RegisterRoutes(router gin.IRoutes) {
	...
	router.GET("/jav/discovery/downloader/settings", getDownloaderSettings)
	router.PUT("/jav/discovery/downloader/settings", updateDownloaderSettings)
	router.PUT("/jav/discovery/downloader/providers/:provider", updateDownloaderProviderSettings)
	router.POST("/jav/discovery/downloader/providers/:provider/test", testDownloaderProvider)
	router.GET("/jav/discovery/downloads", listDiscoveryDownloads)
	router.POST("/jav/discovery/downloads/:id/retry", retryDiscoveryDownload)
	router.POST("/jav/discovery/downloads/:id/cancel", cancelDiscoveryDownload)
	router.DELETE("/jav/discovery/downloads/:id", deleteDiscoveryDownload)
