...
func RegisterRoutes(router gin.IRoutes) {
	...
	router.POST("/jav/discovery/items/:id/downloads", createCloudDriveDownload)
	router.POST("/jav/discovery/sync", triggerJavDiscoverySync)
	router.GET("/jav/discovery/clouddrive/settings", getCloudDriveSettings)
	router.PUT("/jav/discovery/clouddrive/settings", updateCloudDriveSettings)
	router.POST("/jav/discovery/clouddrive/test", testCloudDriveSettings)
	router.GET("/jav/discovery/downloads", listCloudDriveDownloads)
	router.POST("/jav/discovery/downloads/:id/retry", retryCloudDriveDownload)
	router.POST("/jav/discovery/downloads/:id/cancel", cancelCloudDriveDownload)
	router.DELETE("/jav/discovery/downloads/:id", deleteCloudDriveDownload)
